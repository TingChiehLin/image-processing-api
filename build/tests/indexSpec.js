...
describe("image file", function () {
    ...
    it('should not include a list of image files name. Wrong parameter filename name', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var fileName;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(index_1.app).get('/image-process').query('filename')];
                case 1:
                    fileName = _a.sent();
...
describe('Testing GET / endpoint', function () {
    it('it should return status code 404 status. If filename is not included', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(index_1.app).get('/image-process?filename=apple&width=200&height=200').send()];
                case 1:
                    result = _a.sent();
